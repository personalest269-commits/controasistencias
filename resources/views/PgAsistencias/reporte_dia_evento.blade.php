...
<div class="container-fluid">
    <div class="row mb-3">
        <div class="col-12">
            <h4 class="mb-0">Asistencia por Día y Evento</h4>
            <small class="text-muted">Solo se muestran los días dentro del rango que tienen eventos. En cada celda: A asistió (verde), J justificó (azul), F falta (rojo).</small>
        </div>
    </div>
    ...
    <form method="GET" action="{{ route('PgAsistenciasReporteDiaEvento') }}" class="mb-3">
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-10 d-flex align-items-end" style="gap:8px; flex-wrap:wrap;">
                ...
                <a class="btn btn-outline-secondary btn-sm" href="{{ route('PgAsistenciasReportes', ['desde'=>$desde,'hasta'=>$hasta,'departamento_id'=>$departamentoId]) }}">Ir a Reportes (Resumen/Detalle)</a>
            </div>
        </div>
    </form>
