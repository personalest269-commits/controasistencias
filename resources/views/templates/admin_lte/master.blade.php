...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      @if($showFrontendLink)
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ url('/') }}" target="_blank" rel="noopener" class="nav-link">🌍 {{ tr('Frontend') }}</a>
      </li>
      @endif
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      @include('partials.ui_template_switcher_adminlte')
      @endif
      ...
      <li class="dropdown user user-menu open">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                        <img src="{{ $__avatarUrl }}" class="user-image" alt="User Image">
                        <span class="hidden-xs">{{ $__displayName }}</span>
                      </a>
                      <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                          <img src="{{ $__avatarUrl }}" class="img-circle" alt="User Image">
                          <p>
                            {{ $__displayName }}
                        ...
                        <li class="user-footer">
                          <div class="pull-left">
                            <a href="{{ route('userprofile') }}" class="btn btn-default btn-flat">{{ tr('Perfil') }}</a>
                          </div>
                          <div class="pull-right">
                            <a href="{{ route('logout') }}" class="btn btn-default btn-flat">{{ tr('Salir') }} </a>
                          </div>
                        </li>
                      </ul>
                    </li>
    ...
    <div class="sidebar">
      ...
      <div class="form-inline">
        <div class="input-group">
          <input id="menuSearchInput" class="form-control form-control-sidebar" type="search" placeholder="{{ tr('Search') }}" aria-label="{{ tr('Search') }}">
      ...
      <div id="menuSearchNoResult" class="px-3 mt-1 text-muted" style="display:none; font-size: 12px;">{{ tr('No element found!') }}</div>
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        @if(!$usePgMenu)
            ...
            <li class="nav-item @if(Ch::isActive(['userprofile','general-settings']) || URL::full()==url('admin/translations')) menu-open @endif" >                          
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/login-settings') }}" class="nav-link @if(\Request::is('admin/login-settings')) active @endif">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Login Settings</p>
                    </a>
                </li>
