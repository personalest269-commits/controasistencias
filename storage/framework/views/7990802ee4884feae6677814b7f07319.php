...
?>
<?php $__env->startSection('title', 'Gestión de Eventos (Empresas)'); ?>
            ...
            <div class="card-body" id="upcomingList">
                ...
                <?php else: ?>
                    <div class="d-grid" style="gap:12px;">
                        <?php $__currentLoopData = $upcoming; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            ?>
                            <div class="upcoming-item" data-id="<?php echo e($e->id); ?>">
                                <div class="d-flex align-items-start" style="gap:10px;">
                                    <span class="upcoming-dot" style="background:<?php echo e($dot); ?>"></span>
                                    <div>
                                        <p class="upcoming-title js-open" data-id="<?php echo e($e->id); ?>"><?php echo e($e->titulo); ?></p>
                                        <div class="upcoming-meta">
                                            Fecha inicio: <?php echo e($start); ?><br>
                                            Fecha fin: <?php echo e($end); ?>

                                        </div>
                                    </div>
                                </div>
                                <div class="upcoming-actions d-flex" style="gap:8px;">
                                    <button class="btn btn-info btn-sm js-edit" title="Editar" data-id="<?php echo e($e->id); ?>"><i class="fas fa-pen"></i></button>
                                    <button class="btn btn-danger btn-sm js-del" title="Eliminar" data-id="<?php echo e($e->id); ?>"><i class="fas fa-trash"></i></button>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="personas" class="form-control" multiple>
                                ...
                                <?php $__currentLoopData = $personas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($p->id); ?>"><?php echo e($p->nombre_completo); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="fechaInicio" placeholder="<?php echo e($pg_datetime_placeholder); ?>" autocomplete="off">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="fechaFin" placeholder="<?php echo e($pg_datetime_placeholder); ?>" autocomplete="off">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="far fa-calendar"></i></span>
                                </div>
                            </div>
...
<?php $__env->startSection('footer'); ?>
    ...
    <script>
        (function(){
            ...
            const ROUTES = {
                feed: '<?php echo e(route('PgEventosFeed')); ?>',
                upcoming: '<?php echo e(route('PgEventosUpcoming')); ?>',
                get: (id) => '<?php echo e(url('/admin/PgEventosEmpresa/obtener')); ?>/' + id,
                store: '<?php echo e(route('PgEventosEmpresaStore')); ?>',
                update: (id) => '<?php echo e(url('/admin/PgEventosEmpresa/actualizar')); ?>/' + id,
                del: (id) => '<?php echo e(url('/admin/PgEventosEmpresa/eliminar')); ?>/' + id,
            };
...
<?php echo $__env->make("templates.".config("sysconfig.theme").".master", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravelfinal89\resources\views/PgEventosEmpresa/index.blade.php ENDPATH**/ ?>