...
<div class="container-fluid">
    ...
    <form method="GET" action="<?php echo e(route('PgAsistenciasEmpresaIndex')); ?>">
                ...
                <div class="col-md-4">
                    ...
                    <select id="empresa_id" name="empresa_id" class="form-control">
                        ...
                        <?php $__currentLoopData = $empresas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($e->id); ?>" <?php echo e(($empresaId==$e->id)?'selected':''); ?>><?php echo e($e->nombre); ?></option>
    ...
    <form method="POST" action="<?php echo e(route('PgAsistenciasEmpresaActualizar')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
            ...
            <div class="card-header">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex align-items-center" style="gap:8px;">
                        ...
                        <a href="<?php echo e(route('PgAsistenciasEmpresaReportes')); ?>" class="btn btn-warning btn-sm" id="btnReportes">Reportes</a>
                        <button class="btn btn-primary btn-sm" type="submit" id="btnCerrarDia"
                                name="cerrar_dia" value="1"
                                formaction="<?php echo e(route('PgAsistenciasEmpresaCerrarDia')); ?>">
    ...
    <script>
        $(function(){
            ...
            $('#persona_id').select2({
                ...
                language: 'es',
                ajax: {
                    url: '<?php echo e(route('PgAsistenciasEmpresaPersonasSearch')); ?>',
                    dataType: 'json',
                    delay: 250,
            ...
            function savePersona(pid){
                ...
                return $.ajax({
                    method: 'POST',
                    url: '<?php echo e(route('PgAsistenciasEmpresaActualizarItem')); ?>',
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>',
                        fecha: '<?php echo e($fecha); ?>',
                        empresa_id: '<?php echo e($empresaId); ?>',
                        persona_id: pid,
                        eventos: eventos,
...
<?php echo $__env->make("templates.".config("sysconfig.theme").".master", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravelfinal89\resources\views/PgAsistenciasEmpresa/index.blade.php ENDPATH**/ ?>