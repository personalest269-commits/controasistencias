<?php $__env->startSection('head'); ?>
    <link rel="stylesheet" type="text/css" media="screen" href="<?php echo e(asset('assets/css/datatables/tools/css/dataTables.tableTools.css')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/select/select2.min.css')); ?>" />
...
<div class="">
    <div class="page-title">
        <div class="title_left">
            <h3><?php echo app('translator')->get('users.module_title'); ?></h3>
        </div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <div class="row">
                        <div class="col-md-8 col-sm-8 col-xs-7"><h2><?php echo app('translator')->get('users.module_subtitle'); ?></h2></div>
                        <div class="col-md-4 col-sm-4 col-xs-5">
                            <button type="button" class="btn btn-primary form-modal-button pull-right"><?php echo app('translator')->get('users.module_add_new'); ?></button>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="users-form" class="form-horizontal form-label-left" method="post" action="<?php echo route('userscreateorupdate'); ?>" autocomplete="off" enctype="multipart/form-data">
...
<?php $__env->startSection('footer'); ?>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/select/select2.full.js')); ?>"></script>
    ...
    <script type="text/javascript">
        ...
        function ajaxAction(url, action) {
            $.ajax({
                url: url,
                type: action,
                data: {'_token': "<?php echo e(csrf_token()); ?>", 'selected_rows': SelectedCheckboxes()},
                success: function () {}
            });
        }
        ...
        function initPersonaSelect2(preselect) {
            ...
            $sel.select2({
                ...
                , ajax: {
                    url: "<?php echo e(route('users_personas_search')); ?>",
                    dataType: 'json',
                    delay: 250,
        ...
        $(document).ready(function () {
            ...
            ListTable = $('#users-table').DataTable({
                ...
                buttons: ['copy', 'csv', 'excel', 'pdf', 'print',
                    {
                        ...
                        action: function () {
                            ...
                            if (TrashItem) {
                                ajaxAction("<?php echo route('usersdeletemultiple'); ?>", 'DELETE');
                ...
                processing: true,
                serverSide: true,
                ajax: {url: '<?php echo route('userslist'); ?>', data: {'_token': '<?php echo e(csrf_token()); ?>'}},
                columns: [
    ...
    <script src="<?php echo e(asset('admin_lte/plugins/datatables-buttons/js/buttons.flash.min.js')); ?>"></script>
...
<?php echo $__env->make("templates.".config("sysconfig.theme").".master", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravelfinal89\resources\views/users/users.blade.php ENDPATH**/ ?>