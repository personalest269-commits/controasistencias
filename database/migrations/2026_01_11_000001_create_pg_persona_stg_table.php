...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('pg_persona_stg', function (Blueprint $table) {
            ...
            // Columnas del DOC/XLS/API
            $table->string('id', 20)->nullable(); // ID del origen (no es PK de pg_persona)
            ...
            // Llave para actualizar/insertar en pg_persona
